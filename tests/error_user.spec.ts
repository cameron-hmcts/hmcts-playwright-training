...
test.describe('error user checkout', () => {
  ...
  test.skip('times out on finish order at checkout', async ({ inventoryPage, inventoryItemPage, cartPage, checkoutInfoPage, checkoutOverviewPage, checkoutCompletePage }) => {
